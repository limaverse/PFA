...
$services = [
    [
        ...
        'description' => 'Report safety incidents and harassment cases in public transportation with our secure, anonymous system.',
        'link' => 'auth.php?tab=signup',
        'link_text' => 'Report Now'
    ],
    [
        'icon' => 'fa-comments',
        'title' => 'Share Experiences',
        'description' => 'Share your positive and negative transportation experiences to help others and drive improvements.',
        'link' => 'auth.php?tab=signup',
        'link_text' => 'Share Experience'
    ],
    [
        'icon' => 'fa-chart-bar',
        'title' => 'Safety Statistics',
        'description' => 'View statistics and trends about transportation safety issues to stay informed about current challenges.',
        'link' => '#',
    ...
    [
        ...
        'description' => 'Participate in community events and awareness campaigns to promote transportation safety.',
        'link' => '#',
...
$articles = [
    [
        'icon' => 'fa-user-shield',
        'title' => 'Your Rights in Public Transportation',
        'description' => 'Learn about your legal rights and protections when using public transportation in Tunisia.',
        'date' => 'May 15, 2023',
        'views' => '1.2K'
    ],
    [
        ...
        'description' => 'Discover how community-led initiatives are making transportation safer for everyone.',
        'date' => 'April 28, 2023',
        'views' => '987'
    ],
    [
        'icon' => 'fa-traffic-light',
        'title' => 'Transportation Safety Updates',
        'description' => 'Stay informed about the latest safety measures and updates in Tunisia\'s transport system.',
        'date' => 'June 3, 2023',
        'views' => '1.5K'
    ]
];
        ...
        <div class="container">
            ...
            <div class="about-content">
                <div class="about-text">
                    ...
                    <a href="auth.php?tab=signup" class="btn">Join Our Community</a>
                </div>
        ...
        <div class="container">
            ...
            <div class="services-grid">
                ...
                <div class="service-card">
                    ...
                    <a href="<?php echo $service['link']; ?>" class="btn"><?php echo $service['link_text']; ?></a>
                </div>
                <?php endforeach; ?>
            </div>
        </div>
            ...
            <div class="articles-grid">
                ...
                <div class="article-card">
                    <div class="article-image">
                        <i class="fas <?php echo $article['icon']; ?>"></i>
                    </div>
                    <div class="article-content">
                        <h3><?php echo $article['title']; ?></h3>
                        <p><?php echo $article['description']; ?></p>
                        <div class="article-meta">
                            <span><i class="far fa-calendar"></i> <?php echo $article['date']; ?></span>
                            <span><i class="far fa-eye"></i> <?php echo $article['views']; ?> views</span>
                        </div>
